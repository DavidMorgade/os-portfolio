...
const Bear = () => {
  ...
  return (
    <div className="bear font-avenir flex h-full">
      <div className="w-44 overflow-auto bg-gray-700 sidebar">
        <Sidebar cur={state.curSidebar} setMidBar={setMidBar} />
      </div>
      <div
        className="w-60 overflow-auto middlebar"
      ...
      <div className="flex-1 overflow-auto content" bg="gray-50 dark:gray-800">
