...
declare global {
  ...
  const Facetime: typeof import('./components/apps/Facetime')['default']
  const Gmail: typeof import('./components/apps/Gmail')['default']
  const LanguageContext: typeof import('./hooks/useLanguage')['LanguageContext']
  const LanguageProvider: typeof import('./hooks/useLanguage')['LanguageProvider']
  ...
  const NavPage: typeof import('./components/apps/NavPage')['NavPage']
  const OpenAI: typeof import('./components/apps/OpenAI')['default']
  ...
  const useLanguageContext: typeof import('./hooks/useLanguage')['useLanguageContext']
